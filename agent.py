import time
from utils import llm, llm2, load_prompt, search_exam_chunks
...
def agent_answer(user_query):
    ...
    if "YES" in rag_flag:
        ...
        faiss_query = llm2(reading_prompt)
        ...
        yield llm2(generate_exam_prompt)

    else:
        yield "我可以直接回答這個問題:"
        yield llm2(user_query)
